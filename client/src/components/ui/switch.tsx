...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      disabled:opacity-50 data-[state=checked]:bg-neutral-900 
      data-[state=unchecked]:bg-neutral-200 dark:focus-visible:ring-neutral-300 
      dark:focus-visible:ring-offset-neutral-950 dark:data-[state=checked]:bg-violet-600 
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        data-[state=unchecked]:translate-x-0 dark:bg-violet-900`
      )}
    />
  </SwitchPrimitives.Root>
))
